<x-layout>
  <div class="mx-4">
    <x-card class="p-10 max-w-lg mx-auto mt-24" >
      ...
      <header class="text-center justify-center content-center place-items-center">
        <h2 class="text-2xl font-bold uppercase mb-1">Edit Gig</h2>
        <p class="mb-4">Update Laravel Job or Project</p>
        <img class="mb-6 place-items-center" src="{{ $listing->logo ? asset('storage/' . $listing->logo) : asset('/images/no-image.png') }}" alt="" />
